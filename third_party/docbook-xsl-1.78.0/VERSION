...
<xsl:param name="PreviousRelease">1.77.1</xsl:param>
<xsl:param name="PreviousReleaseRevision">9401</xsl:param>
<xsl:param name="Revision">$Revision: 9696 $</xsl:param>
