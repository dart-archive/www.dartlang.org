...
"%":"Clipboard|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedString"},
kn:{
"^":"bool/Gv;",
...
VX:{
"^":"Tp:13;c",
call$1:function(a){return this.c(a)}}}],["","file:///Users/shailentuli/workspace/dart-samples/html5/web/dnd/basics/basics.dart",,V,{
"^":"",
Iq:[function(){new V.Cx(null).wE(0)},"call$0","eE",0,0,0],
Cx:{
"^":"a;qk",
wE:function(a){var z,y,x,w
z=W.vD(document.querySelectorAll("#columns .column"),null)
...
a.dataTransfer.setData("text/html",x.ghf(y))},"call$1","gkb",2,0,14],
rm:[function(a){var z,y
J.pP(J.l2(a)).Rz(0,"moving")
z=W.vD(document.querySelectorAll("#columns .column"),null)
for(y=z.gA(z);y.G();)J.pP(y.lo).Rz(0,"over")},"call$1","gKI",2,0,14],
KO:[function(a){J.pP(J.l2(a)).h(0,"over")},"call$1","gN5",2,0,14],
tz:[function(a){var z=J.RE(a)
z.e6(a)
z.gtv(a).dropEffect="move"},"call$1","gw5",2,0,14],
PZ:[function(a){J.pP(J.l2(a)).Rz(0,"over")},"call$1","grj",2,0,14],
...
J.Qy(x,w.ghf(y))
w.shf(y,z.gtv(a).getData("text/html"))}},"call$1","gPd",2,0,14]}},1],["dart._internal","dart:_internal",,H,{
"^":"",
...
glX:function(a){return H.VM(new W.RO(a,C.lo.Ph,!1),[null])},
...
gNf:function(a){return H.VM(new W.eu(a,C.tG.Ph,!1),[null])},
...
glX:function(a){return H.VM(new W.pu(this,!1,C.lo.Ph),[null])},
...
z.vv=null
z.X5=0
z.zN=z.zN+1&67108863}this.Hj.xO(0)},"call$0","gJK",0,0,0],
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"Vv",ret:J.kn,args:[W.cv,J.O,J.O,W.JQ]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"WD",args:[J.O]},{func:"a5",void:true,args:[W.Aj]},{func:"uu",void:true,args:[P.a],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"qu",void:true,args:[W.KV]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
VX.prototype=$desc
function Cx(qk){this.qk=qk}Cx.builtin$cls="Cx"
if(!"name" in Cx)Cx.name="Cx"
$desc=$collectedClasses.Cx
if($desc instanceof Array)$desc=$desc[1]
Cx.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
GS.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,P2,nB,i3,it,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,He,HA,vH,Rr,xO,Em,NW,rV,Wy,QF,hs,cm,BK,ae,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,xn,Vb,QH,ST,X2,tb,pA,Mi,HL,In,wP,eP,A6,Og,u8,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,xe,Hw,bn,Ik,xI,Aj,Q0,eY,KV,BH,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,u2,bX,lr,MC,iQ,qI,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,fA,Oi,UM,hq,WS,NL,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,ph,IT,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,pQ,um,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,jr,j2,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UD,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,yx,xt,wx,P0,xl,Xr,Sl,Qm,ET,V6,eo,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,Vg,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,ZQ,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,Cx,aL,a7,i1,xy,MH,A8,U5,SO,SU,Ca,Gm,JI,WV,yZ,tK,OR,Bg,b8,vs,da,pV,U7,cX,rH,rq,RW,RT,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,O9,yU,nP,KA,Vo,qB,ez,fI,LV,DS,dp,B3,CR,Qk,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,W0,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,VG,wz,B1,Cv,zL,ec,e7,dx,x5,hm,HR,tJ,i7,nF,FK,Si,vf,Fc,hD,I4,Fk,RO,eu,pu,Ov,qO,RX,JQ,Pb,zW,mD,Eg,m6,ct,IA,Ow,W9,dW,rB,kF,mk,MM,fm,O7,IU,b0,DV,Ob,GV,As,GE,D7,Zf,GS]}