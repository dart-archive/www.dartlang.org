...
z.K5(a,b)},function(a){return this.w0(a,null)},"pm","call$2","call$1","gYJ",2,2,13,3]},
vs:{
...
else if((z&3)===0)this.kW().h(0,new P.DS(a,b,null))},function(a){return this.xW(a,null)},"Qj","call$2","call$1","gGj",2,2,13,3],
...
$isiP:true,
static:{"^":"Oj,Vp,Ej,p2,ch,QC,Px,Yp,kc,Gi,Fz,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
return y}return a}}}],["","file:///Users/shailentuli/workspace/dart-samples/html5/web/indexeddb/todo/todo.dart",,N,{
"^":"",
Iq:[function(){var z,y
z=N.nM()
y=window
J.e7(y.indexedDB||y.webkitIndexedDB||y.mozIndexedDB,"todo",z.gnV(),z.E9).ml(z.gDi()).OA(z.gmT())},"call$0","eE",0,0,0],
a8:{
"^":"a;cS,E9,RB,LK",
Ah:[function(a){var z
...
if(typeof console!="undefined")console.log(z)},"call$1","gmT",2,0,1],
PY:[function(a){this.cS=a
this.kO()},"call$1","gDi",2,0,22],
Ef:[function(a){var z,y
z=P.o0(H.Go(J.l2(a),"$ispZ").result,!1)
if(J.RE(z).gmV(z).contains("todos")!==!0){y=H.B7([],P.L5(null,null,null,null,null))
y.u(0,"keyPath","timeStamp")
C.Ij.UF(z,"todos",y)}},"call$1","gnV",2,0,23],
px:function(a){var z,y
z=J.hr(J.Nu(this.cS,"todos","readwrite"),"todos")
y=Date.now()
new P.iP(y,!1).EK()
return J.WR(z,H.B7(["text",a,"timeStamp",C.CD.bu(y)],P.L5(null,null,null,null,null))).ml(new N.AX(this)).OA(new N.R1(this))},
aV:function(a){J.E1(J.hr(J.Nu(this.cS,"todos","readwrite"),"todos"),a).Rx(new N.t9(this),this.gmT())},
kO:function(){this.LK.textContent=""
var z=J.hr(J.Nu(this.cS,"todos","readwrite"),"todos")
z.toString
P.wg(z.openCursor(null),!0).kT(new N.aI(this),this.gmT())},
...
AX:{
"^":"Tp:10;a",
call$1:function(a){return this.a.kO()}},
R1:{
"^":"Tp:10;b",
call$1:function(a){return this.b.gmT()}},
t9:{
"^":"Tp:10;a",
call$1:function(a){return this.a.kO()}},
aI:{
"^":"Tp:10;a",
call$1:function(a){this.a.vi(J.Vm(a))}},
Hr:{
"^":"Tp:10;a,b",
call$1:function(a){return this.a.aV(J.UQ(this.b,"timeStamp"))}}},1],])
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"uu",void:true,args:[P.a],opt:[P.mE]},{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"Za",args:[J.O,null]},{func:"ZH",args:[J.im]},{func:"iR",args:[J.im,null]},{func:"lR",void:true,args:[P.xH]},{func:"rG",void:true,args:[P.yK]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
xH.prototype=$desc
xH.prototype.gmV=function(receiver){return receiver.objectStoreNames}
...
if($desc instanceof Array)$desc=$desc[1]
xL.prototype=$desc
function a8(cS,E9,RB,LK){this.cS=cS
this.E9=E9
this.RB=RB
this.LK=LK}a8.builtin$cls="a8"
...
if($desc instanceof Array)$desc=$desc[1]
AX.prototype=$desc
function R1(b){this.b=b}R1.builtin$cls="R1"
if(!"name" in R1)R1.name="R1"
$desc=$collectedClasses.R1
if($desc instanceof Array)$desc=$desc[1]
R1.prototype=$desc
function t9(a){this.a=a}t9.builtin$cls="t9"
...
if($desc instanceof Array)$desc=$desc[1]
Hr.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,Yl,cv,Fs,hY,pS,D0,as,dU,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,Q0,eY,KV,BH,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,Zv,Q7,W2,e3,xH,hK,SI,pZ,m9,nq,yK,Dh,ZJ,mU,eZ,IT,nV,Zc,ui,D6,DQ,Sm,dx,es,jw,lv,pf,NV,W1,zo,wf,TC,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,tc,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,UD,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,WZ,ET,df,zU,K8,xj,dE,ZA,dT,Pq,LN,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,bL,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,b8,Pf,mJ,vs,da,pV,U7,cX,rH,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,tC,ea,Zz,Xi,MF,u8,yU,nP,KA,Vo,qB,ez,aA,LV,DS,dp,B3,CR,Qk,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,ar,lD,ZQ,Sw,KG,CL,iP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,EH,An,c8,a,mE,Rn,wv,zL,ec,wi,hm,x5,I2,RO,eu,Ov,Pb,W9,dW,qy,UE,IU,b0,Dg,Ob,GV,Pg,fj,Ip,zW,wF,rG,yh,wO,Tm,ib,a9,YL,KC,xL,a8,aH,AX,R1,t9,aI,Hr]}