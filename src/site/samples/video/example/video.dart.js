...
y=$globalState.XC
y.u(y,x,z)
z.postMessage($.Gy($.Pd(["command","start","id",x,"replyTo",$.Gy(c),"functionName",a])))},La:function(a,b){var z=$.ZF()
z.h7(a)
$.Uc(z.Gx).ml(new $.yc(b))},Gy:function(a){var z
...
LV:function(a,b){$.La([a,b],new $.Ua(this,a,b))},
n:function(a,b){if(b==null)return!1
...
LV:function(a,b){$.La([a,b],new $.wd(this,a,b))},
...
x.pop()}return z.goQ()},K0:function(a,b,c){var z
...
$isFO:true,
$isb8:true,
static:{"":"Qo,VZ,A3,Cz,AI,xW,qH",Uc:function(a){var z,y,x,w,v,u
z={}
z.a=null
z.b=null
y=new $.Hc(z)
...
z.Ut=z.Ut-1
z.UZ(new $.o4(this,a),!1)},
ET:function(a){var z=this.xS
z.Ut=z.Ut-1
z.UZ(new $.zE(this,a),!1)},
...
mw:function(a){if(typeof a!=="string")return this.NA(1,a)
this.oQ=this.oQ+a},
NA:function(a,b){var z=typeof b==="string"?b:$.d(b)
this.oQ=this.oQ+z},
...
z.PD(a)
return z}}}}],["dart.dom.html","dart:html",,{RO:{"":"qh;",
X5:function(a,b,c,d){var z=new $.xC(0,this.hA,this.fV,a,this.dW)
z.wv()
return z}},eu:{"":"RO;hA,fV,dW"},xC:{"":"MO;HX,hA,fV,DR,dW",
...
if(z!=null)$.Io(this.hA,this.fV,z,this.dW)}},Fk:{"":"a;fV"},qE:{"":"cv;"},Gh:{"":"qE;",
...
bu:function(a){return a.localName}},Fs:{"":"qE;fg:height%,R:width%"},D0:{"":"vB;",
Rt:function(a,b,c,d){return a.addEventListener(b,$.tR(c,1),d)},
ox:function(a,b,c,d){return a.removeEventListener(b,$.tR(c,1),d)}},Yu:{"":"qE;B:length="},tb:{"":"qE;fg:height%,R:width%"},pA:{"":"qE;fg:height%,R:width%"},Mi:{"":"qE;fg:height%,R:width%"},El:{"":"qE;",
gDV:function(a){C.dI.Qm
return new $.eu(a,C.dI.fV,!1)},
gd4:function(a){C.xA.Qm
return new $.eu(a,C.xA.fV,!1)},
gDe:function(a){C.ZZ.Qm
return new $.eu(a,C.ZZ.fV,!1)},
gqc:function(a){C.Kv.Qm
return new $.eu(a,C.Kv.fV,!1)}},uH:{"":"D0;",
bu:function(a){var z=a.nodeValue
return z==null?$.vB.prototype.bu.call(this,a):z}},G7:{"":"qE;fg:height%,R:width%"},lp:{"":"qE;B:length="},aG:{"":"El;fg:height%,Qh:videoHeight=,KF:videoWidth=,R:width%"},K5:{"":"D0;",
...
bu:function(a){return a.toString()}}}],["dart.dom.svg","dart:svg",,{jw:{"":"nj;fg:height=,R:width="},lv:{"":"nj;fg:height=,R:width="},pf:{"":"nj;fg:height=,R:width="},py:{"":"nj;fg:height=,R:width="},Ef:{"":"nj;fg:height=,R:width="},mC:{"":"nj;fg:height=,R:width="},wf:{"":"nj;fg:height=,R:width="},ih:{"":"nj;fg:height=,R:width="},tk:{"":"nj;fg:height=,R:width="},me:{"":"nj;fg:height=,R:width="},oB:{"":"nj;fg:height=,R:width="},EI:{"":"nj;fg:height=,R:width="},MI:{"":"nj;fg:height=,R:width="},bM:{"":"nj;fg:height=,R:width="},Qy:{"":"nj;fg:height=,R:width="},ju:{"":"nj;fg:height=,R:width="},QN:{"":"nj;fg:height=,R:width="},q8:{"":"tp;fg:height=,R:width="},tp:{"":"nj;"},SL:{"":"tp;fg:height=,R:width="},Yd:{"":"nj;fg:height=,R:width="},Gr:{"":"nj;fg:height=,R:width="},NJ:{"":"tp;fg:height=,R:width="},nj:{"":"d5;"},d5:{"":"cv;"},iv:{"":"tp;fg:height=,R:width="},UM:{"":"tp;fg:height=,R:width="}}],["dart.isolate","dart:isolate",,{WP:function(){if($.Dz==null)$.Dz=$.K4()
...
$asXj:null,
$isList:true,
$isXj:true}}],["video.dart","file:///Users/shailentuli/workspace/dart-samples/web/html5/video/basics/video.dart",,{E2:function(){$.jS()},pu:{"":"a;RH,zv,YX,XI,qb,Ag,ui,o1?,H2,pl",
...
if(y==null)throw y.V()
w=y/x
this.Ag.drawImage(z,0,0)
z=this.ui
y=this.YX
v=$.RE(y)
z.clearRect(0,0,v.gR(y),v.gfg(y))
for(z=this.H2,u=0;u<x;++u){t=u*w
s=$.e0(this.RH)
y=this.XI
if(u>=y.length)throw $.e(u)
y=y[u]
this.ui.drawImage(this.zv,t,0,w,s,t,y+0+z,w,s)
y=this.XI
if(u>=y.length)throw $.e(u)
y=y[u]
v=this.qb
...
r=v[u]
if(u>=y.length)throw $.e(u)
v[u]=r+y[u]}else{if(u>=y.length)throw $.e(u)
y[u]=-y[u]}}z=window
C.ol.rK(z)
C.ol.nV(z,new $.ff(this))},
kE:function(){var z,y,x
this.RH=document.querySelector("#video-canvas-fancy")
this.zv=document.querySelector("#canvas-copy-fancy")
this.YX=document.querySelector("#canvas-draw-fancy")
this.XI=[]
this.qb=[]
for(z=this.pl,y=-2,x=0;x<z;++x){this.XI.push(0)
this.qb.push(y)
y+=0.4}z=$.PZ(this.RH)
new $.xC(0,z.hA,z.fV,new $.cF(this),z.dW).wv()
z=$.Rm(this.RH)
new $.xC(0,z.hA,z.fV,new $.hw(this),z.dW).wv()
z=$.fe(this.RH)
new $.xC(0,z.hA,z.fV,new $.p4(this),z.dW).wv()
z=$.S6(this.RH)
new $.xC(0,z.hA,z.fV,new $.yR(this),z.dW).wv()},
static:{jS:function(){var z=new $.pu(null,null,null,null,null,null,null,!1,100,4)
z.kE()
return z}}},cF:{"":"Tp;a",
call$1:function(a){return this.a.zO()}},hw:{"":"Tp;b",
call$1:function(a){var z=this.b
z.so1(!0)
z.iM()
return}},p4:{"":"Tp;c",
call$1:function(a){this.c.so1(!1)
return}},yR:{"":"Tp;d",
call$1:function(a){this.d.so1(!1)
return}},ff:{"":"Tp;a",
call$1:function(a){this.a.iM()
return!1}}},1],])
...
$.EK=function(a){return $.RE(a).gKF(a)}
...
$.PZ=function(a){return $.RE(a).gDV(a)}
...
return $.x(a).n(a,b)}
$.e0=function(a){return $.RE(a).gQh(a)}
