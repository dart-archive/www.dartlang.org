...
"%":"ArrayBuffer|Blob|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedNumberList"},kn:{"":"bool/Pu;",
...
a.$identityHash=z}return z},vx:function(a){throw H.b(P.cD(a))},IH:function(a,b){var z,y
...
pP:function(a){a.Qu(this.P)}},dp:{"":"a;",
pP:function(a){a.SY()},
gLD:function(){return},
...
if(b!=null)J.vP(z,b)
if(a!=null)J.OE(z,a)
return z},VF:function(a){var z=$.X3
if(z===C.NU)return a
...
"%":"HTMLAnchorElement"},IF:{"":"qE;oc:name=,P:value=","%":"HTMLButtonElement"},Ny:{"":"qE;fg:height%,R:width%",
eW:function(a,b,c){return a.getContext(b)},
Bf:function(a,b){return this.eW(a,b,null)},
"%":"HTMLCanvasElement"},Y5:{"":"Pu;","%":"WebGLRenderingContext;CanvasRenderingContext"},Gc:{"":"Y5;",
...
bu:function(a){return a.toString()},
"%":"DOMException"},cv:{"":"KV;xr:className%",
gDD:function(a){return new W.I4(a)},
bu:function(a){return a.localName},
$iscv:true,
"%":";Element"},Fs:{"":"qE;fg:height%,oc:name=,R:width%","%":"HTMLEmbedElement"},hY:{"":"ea;kc:error=","%":"ErrorEvent"},ea:{"":"Pu;","%":"AudioProcessingEvent|AutocompleteErrorEvent|BeforeLoadEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CustomEvent|DeviceMotionEvent|DeviceOrientationEvent|HashChangeEvent|IDBVersionChangeEvent|MIDIConnectionEvent|MIDIMessageEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MessageEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|ResourceProgressEvent|SecurityPolicyViolationEvent|SpeechInputEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;Event"},D0:{"":"Pu;",
On:function(a,b,c,d){return a.addEventListener(b,H.tR(c,1),d)},
Y9:function(a,b,c,d){return a.removeEventListener(b,H.tR(c,1),d)},
"%":"MediaStream;EventTarget"},as:{"":"qE;oc:name=","%":"HTMLFieldSetElement"},Yu:{"":"qE;B:length=,oc:name=","%":"HTMLFormElement"},tb:{"":"qE;fg:height%,oc:name=,R:width%","%":"HTMLIFrameElement"},Sg:{"":"Pu;Rn:data=,fg:height=,R:width=",$isSg:true,"%":"ImageData"},pA:{"":"qE;fg:height%,R:width%","%":"HTMLImageElement"},Mi:{"":"qE;fg:height%,oc:name=,P:value=,R:width%",$iscv:true,"%":"HTMLInputElement"},MX:{"":"qE;oc:name=","%":"HTMLKeygenElement"},wP:{"":"qE;P:value=","%":"HTMLLIElement"},M6:{"":"qE;oc:name=","%":"HTMLMapElement"},El:{"":"qE;kc:error=","%":"HTMLAudioElement;HTMLMediaElement"},Ee:{"":"qE;oc:name=","%":"HTMLMetaElement"},Qb:{"":"qE;P:value=","%":"HTMLMeterElement"},Aj:{"":"w6;","%":"DragEvent|MSPointerEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|PointerEvent|WheelEvent"},KV:{"":"D0;",
...
$isqC:true,
$isXj:true,
"%":"NodeList|RadioNodeList"},G7:{"":"qE;fg:height%,oc:name=,R:width%","%":"HTMLObjectElement"},Ql:{"":"qE;P:value=","%":"HTMLOptionElement"},wL:{"":"qE;oc:name=,P:value=","%":"HTMLOutputElement"},HD:{"":"qE;oc:name=,P:value=","%":"HTMLParamElement"},KR:{"":"qE;P:value=","%":"HTMLProgressElement"},lp:{"":"qE;B:length=,oc:name=,P:value=","%":"HTMLSelectElement"},zD:{"":"ea;kc:error=","%":"SpeechRecognitionError"},FB:{"":"qE;oc:name=,P:value=","%":"HTMLTextAreaElement"},w6:{"":"ea;","%":"CompositionEvent|FocusEvent|KeyboardEvent|SVGZoomEvent|TextEvent|TouchEvent;UIEvent"},aG:{"":"El;fg:height%,R:width%","%":"HTMLVideoElement"},Oi:{"":"D0;",
bu:function(a){return a.toString()},
...
$is_aB:true},nN:{"":"Pu+lD;",$isList:true,$asWO:null,$isqC:true},ec:{"":"nN+Gm;",$asWO:null,$isList:true,$isqC:true},yo:{"":"Pu+lD;",$isList:true,$asWO:null,$isqC:true},x5:{"":"yo+Gm;",$asWO:null,$isList:true,$isqC:true},D9:{"":"a;",
aN:function(a,b){var z,y
...
p5:function(a){new W.E9(this.CE).MW.setAttribute("class",a.zV(a," "))}}}],["dart.isolate","dart:isolate",,P,{rR:{"":"a;"}}],["dart.math","dart:math",,P,{J:function(a,b){var z
...
if(z)return b
return a}}],["dart.typed_data","dart:typed_data",,P,{AS:{"":"Pu;",
aq:function(a,b,c){var z=J.Wx(b)
if(z.C(b,0)||z.F(b,c))throw H.b(P.TE(b,0,c))
else throw H.b(new P.AT("Invalid list index "+H.d(b)))},
"%":"DataView;ArrayBufferView;xG|Vj|DH|RK|Hn|Tk|e3|ZK|Th|z9|KB|Si|Rb|nb|na|Vju|xGn|RKu|u0|fb"},oI:{"":"Vj;",
...
$isqC:true,
$isXj:true,
"%":";Uint8Array"},xG:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},Vj:{"":"xG+SU;",$asWO:null},DH:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},RK:{"":"DH+SU;",$asWO:null},Hn:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},Tk:{"":"Hn+SU;",$asWO:null},e3:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},ZK:{"":"e3+SU;",$asWO:null},Th:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},z9:{"":"Th+SU;",$asWO:null},KB:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},Si:{"":"KB+SU;",$asWO:null},Rb:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},nb:{"":"Rb+SU;",$asWO:null},na:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},Vju:{"":"na+SU;",$asWO:null},xGn:{"":"AS+lD;",$isList:true,$asWO:null,$isqC:true},RKu:{"":"xGn+SU;",$asWO:null},u0:{"":"AS;",$isList:true,
$asWO:function(){return[J.im]},
$isqC:true,
$isXj:true,
...
return a},nl:{"":"a;Rn>,fg>,R>",$isnl:true,$isSg:true},As:{"":"a;",
...
$is_aB:true}}],["","file:///Users/shailentuli/workspace/dart-samples/web/html5/canvas/imagefilters/imagefilters.dart",,Z,{E2:function(){var z,y,x,w
z=document.querySelector(".orig")
y=new W.RO(window,C.fK.Ph,!1)
H.VM(y,[null])
x=new W.xC(0,y.uv,y.Ph,W.VF(new Z.em(z)),y.Sg)
H.VM(x,[H.W8(y,"RO",0)])
x.Zz()
x=document.querySelector("[name = \"grayscale\"]")
x.toString
y=C.T1.Ph
x=new W.Cq(x,y,!1)
H.VM(x,[null])
w=new W.xC(0,x.uv,x.Ph,W.VF(new Z.Lb(z)),x.Sg)
H.VM(w,[H.W8(x,"RO",0)])
w.Zz()
w=document.querySelector("[name = \"brightness\"]")
w.toString
w=new W.Cq(w,y,!1)
H.VM(w,[null])
x=new W.xC(0,w.uv,w.Ph,W.VF(new Z.QA(40,z)),w.Sg)
H.VM(x,[H.W8(w,"RO",0)])
x.Zz()
x=document.querySelector("[name = \"threshold\"]")
x.toString
x=new W.Cq(x,y,!1)
H.VM(x,[null])
w=new W.xC(0,x.uv,x.Ph,W.VF(new Z.Cv(128,z)),x.Sg)
H.VM(w,[H.W8(x,"RO",0)])
w.Zz()
w=document.querySelector("[name = \"sharpen\"]")
w.toString
w=new W.Cq(w,y,!1)
H.VM(w,[null])
x=new W.xC(0,w.uv,w.Ph,W.VF(new Z.ed([0,-1,0,-1,5,-1,0,-1,0],z)),w.Sg)
H.VM(x,[H.W8(w,"RO",0)])
x.Zz()
x=document.querySelector("[name = \"blur\"]")
x.toString
x=new W.Cq(x,y,!1)
H.VM(x,[null])
w=new W.xC(0,x.uv,x.Ph,W.VF(new Z.wa([0.1111111111111111,0.1111111111111111,0.1111111111111111,0.1111111111111111,0.1111111111111111,0.1111111111111111,0.1111111111111111,0.1111111111111111,0.1111111111111111],z)),x.Sg)
H.VM(w,[H.W8(x,"RO",0)])
w.Zz()
w=document.querySelector("[name = \"sobel\"]")
w.toString
w=new W.Cq(w,y,!1)
H.VM(w,[null])
x=new W.xC(0,w.uv,w.Ph,W.VF(new Z.Or([-1,0,1,-2,0,2,-1,0,1],[-1,-2,-1,0,0,0,1,2,1],z)),w.Sg)
H.VM(x,[H.W8(w,"RO",0)])
x.Zz()
x=document.querySelector("[name = \"custom\"]")
x.toString
y=new W.Cq(x,y,!1)
H.VM(y,[null])
x=new W.xC(0,y.uv,y.Ph,W.VF(new Z.YL(z)),y.Sg)
H.VM(x,[H.W8(y,"RO",0)])
x.Zz()},cE:function(a){var z,y,x,w
...
z=z.gDD(y)
z.h(z,"hide")
z=J.pP(y.previousElementSibling)
z.Rz(z,"hide")
z=J.pP(y.previousElementSibling)
z.h(z,"show")
...
x.sR(y,z.gR(b))
x.sfg(y,z.gfg(b))
J.cj(H.Go(x.Bf(y,"2d"),"$isGc"),b,0,0)
x=J.pP(y.previousElementSibling)
x.Rz(x,"show")
x=J.pP(y.previousElementSibling)
x.h(x,"hide")
x=new W.I4(y)
...
z=J.pP(document.querySelector(z).previousElementSibling).DG()
if(z.tg(z,"hide"))Z.nd(a)
else Z.B0(a,b.call$0())},le:{"":"a;Iv",
...
z=J.ns(this.Iv)
for(y=C.i7(z),x=0;x<y;x+=4){w=C.i7(z)
if(x>=w)throw H.e(z,x)
v=z[x]
u=x+1
if(u>=w)throw H.e(z,u)
t=z[u]
s=x+2
if(s>=w)throw H.e(z,s)
r=z[s]
q=C.ON.yu(0.2126*v)+C.ON.yu(0.7152*t)+C.ON.yu(0.0722*r)
w=C.i7(z)
if(s>=w)throw H.e(z,s)
z[s]=q
if(u>=w)throw H.e(z,u)
z[u]=q
if(x>=w)throw H.e(z,x)
z[x]=q}return this.Iv},
Vh:function(a){var z,y,x,w,v,u
z=this.Iv
y=J.ns(z)
for(x=C.i7(y),w=C.i7(y),v=0;v<x;v+=4){if(v>=w)throw H.e(y,v)
y[v]=y[v]+a
u=v+1
if(u>=w)throw H.e(y,u)
y[u]=y[u]+a
u=v+2
if(u>=w)throw H.e(y,u)
y[u]=y[u]+a}return z},
...
s=y[t]
r=v+2
if(r>=w)throw H.e(y,r)
q=0.2126*u+0.7152*s+0.0722*y[r]>=a?255:0
y[r]=q
y[t]=q
y[v]=q}return z},
iX:function(a0,a1){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a
z=a1?1:0
y=a0.length
...
y=s-1
p=0
for(;p<s;++p){if(typeof t!=="number")throw H.s(t)
v=t-1
o=p*t
n=0
for(;n<t;++n){m=(o+n)*4
for(l=0,k=0,j=0,i=0,h=0;h<x;++h)for(g=p+h-w,f=h*x,e=0;e<x;++e){d=(P.J(y,P.y(0,g))*t+P.J(v,P.y(0,n+e-w)))*4
c=f+e
if(c<0||c>=a0.length)throw H.e(a0,c)
b=a0[c]
c=C.i7(u)
if(d>>>0!==d||d>=c)throw H.e(u,d)
a=u[d]
if(typeof b!=="number")throw H.s(b)
l+=a*b
a=d+1
if(a>=c)throw H.e(u,a)
k+=u[a]*b
a=d+2
if(a>=c)throw H.e(u,a)
j+=u[a]*b
...
if(a>=c)throw H.e(u,a)
i+=u[a]*b}g=C.CD.yu(l)
if(m>>>0!==m||m>=C.i7(q))throw H.e(q,m)
q[m]=g
g=m+1
f=C.CD.yu(k)
if(g>=C.i7(q))throw H.e(q,g)
q[g]=f
f=m+2
g=C.CD.yu(j)
if(f>=C.i7(q))throw H.e(q,f)
q[f]=g
g=m+3
f=C.CD.yu(i+z*(255-i))
if(g>=C.i7(q))throw H.e(q,g)
...
x=this.ER(z,a)
w=this.YD(y.R,y.fg)
for(v=J.RE(w),u=y.Rn,t=x.Rn,s=0;s<C.i7(v.gRn(w));s+=4){if(s>=C.i7(u))throw H.e(u,s)
r=Math.abs(u[s])
q=v.gRn(w)
p=C.CD.yu(r)
if(s>=C.i7(q))throw H.e(q,s)
q[s]=p
if(s>=C.i7(t))throw H.e(t,s)
o=Math.abs(t[s])
p=v.gRn(w)
q=s+1
n=C.CD.yu(o)
if(q>=C.i7(p))throw H.e(p,q)
p[q]=n
n=v.gRn(w)
q=s+2
p=C.CD.yu((r+o)/4)
if(q>=C.i7(n))throw H.e(n,q)
n[q]=p
p=v.gRn(w)
q=s+3
if(q>=C.i7(p))throw H.e(p,q)
...
u=w.gR(a0)
t=w.gfg(a0)
w=new Float32Array(J.p0(J.p0(u,t),4))
...
w=t-1
q=0
for(;q<t;++q){if(typeof u!=="number")throw H.s(u)
p=u-1
o=q*u
n=0
for(;n<u;++n){m=(o+n)*4
for(l=0,k=0,j=0,i=0,h=0;h<y;++h)for(g=q+h-x,f=h*y,e=0;e<y;++e){d=(P.J(w,P.y(0,g))*u+P.J(p,P.y(0,n+e-x)))*4
c=f+e
if(c<0||c>=9)throw H.e(a1,c)
b=a1[c]
c=C.i7(v)
if(d>>>0!==d||d>=c)throw H.e(v,d)
a=v[d]
if(typeof b!=="number")throw H.s(b)
l+=a*b
a=d+1
if(a>=c)throw H.e(v,a)
k+=v[a]*b
a=d+2
if(a>=c)throw H.e(v,a)
j+=v[a]*b
...
if(a>=c)throw H.e(v,a)
i+=v[a]*b}g=C.i7(r)
if(m>>>0!==m||m>=g)throw H.e(r,m)
r[m]=l
f=m+1
if(f>=g)throw H.e(r,f)
r[f]=k
f=m+2
if(f>=g)throw H.e(r,f)
r[f]=j
...
$is_aB:true},VW:{"":"Tp;c",
call$0:function(){var z=new Z.le(null)
z.Iv=z.Wu(this.c)
return z.nH()}},QA:{"":"Tp;d,e",
call$1:function(a){return Z.ws("brightness",new Z.oZ(this.d,this.e))},
$is_aB:true},oZ:{"":"Tp;f,g",
call$0:function(){var z=new Z.le(null)
z.Iv=z.Wu(this.g)
return z.Vh(this.f)}},Cv:{"":"Tp;h,i",
call$1:function(a){return Z.ws("threshold",new Z.y8(this.h,this.i))},
$is_aB:true},y8:{"":"Tp;j,k",
call$0:function(){var z=new Z.le(null)
z.Iv=z.Wu(this.k)
return z.MY(this.j)}},ed:{"":"Tp;l,m",
call$1:function(a){return Z.ws("sharpen",new Z.Hi(this.l,this.m))},
$is_aB:true},Hi:{"":"Tp;n,o",
call$0:function(){var z=new Z.le(null)
z.Iv=z.Wu(this.o)
return z.Ho(this.n)}},wa:{"":"Tp;p,q",
call$1:function(a){return Z.ws("blur",new Z.BT(this.p,this.q))},
$is_aB:true},BT:{"":"Tp;r,s",
call$0:function(){var z=new Z.le(null)
z.Iv=z.Wu(this.s)
return z.Ho(this.r)}},Or:{"":"Tp;t,u,v",
call$1:function(a){return Z.ws("sobel",new Z.PY(this.t,this.u,this.v))},
$is_aB:true},PY:{"":"Tp;w,x,y",
call$0:function(){var z=new Z.le(null)
z.Iv=z.Wu(this.y)
...
$is_aB:true},u8:{"":"Tp;A",
call$0:function(){var z,y,x,w
z=W.vD(document.querySelector("#customMatrix").querySelectorAll("input"),null)
y=P.A(null,null)
for(x=z.Sn,w=0;w<x.length;++w)y.push(H.IH(J.Vm(x[w]),null))
x=new Z.le(null)
x.Iv=x.Wu(this.A)
return x.iX(y,!0)}}},1],])
...
init.globalFunctions.lS=Z.lS=new H.yh(Z.E2,"lS")
W.KV.$isa=true
J.im.$isint=true
J.im.$isa=true
J.VA.$isa=true
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner(function() { H.Rq(Z.lS); });
  } else {
    H.Rq(Z.lS);
  }
})
