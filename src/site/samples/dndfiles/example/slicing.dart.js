...
return}else return a},nN:{"":"vB+FN;",$isList:true,$aszM:null},ec:{"":"nN+Gm;",$aszM:null,$isList:true},yo:{"":"vB+FN;",$isList:true,$aszM:null},kE:{"":"yo+Gm;",$aszM:null,$isList:true},D9:{"":"a;",
aN:function(a,b){var z,y
...
Id:function(a){return a.namespaceURI==null}},RO:{"":"qh;hA,fV,dW",
...
static:{yB:function(a){return new $.W9(a,$.q8(a),-1,null)}}},qE:{"":"cv;"},Gh:{"":"qE;oc:name=,N:target=",
bu:function(a){return a.toString()}},fY:{"":"qE;N:target="},VH:{"":"qE;N:target="},Az:{"":"vB;tL:size=",
BY:function(a,b,c,d){return a.slice(b,c,d)},
yh:function(a,b,c){return a.slice(b,c)}},IF:{"":"qE;oc:name=,P:value=",$isIF:true,$asIF:null},OM:{"":"uH;B:length="},Nh:{"":"vB;",
bu:function(a){return a.toString()}},cv:{"":"uH;",
bu:function(a){return a.localName}},Fs:{"":"qE;oc:name="},ea:{"":"vB;",
...
$asXj:null,
$isList:true,
$isXj:true},Yu:{"":"qE;B:length=,oc:name=,N:target="},tb:{"":"qE;oc:name="},Mi:{"":"qE;J5:files=,oc:name=,tL:size=,P:value=",$isD0:true,$asD0:null},MX:{"":"qE;oc:name="},wP:{"":"qE;P:value="},M6:{"":"qE;oc:name="},GS:{"":"qE;oc:name="},Qb:{"":"qE;P:value="},uH:{"":"D0;",
bu:function(a){var z=a.nodeValue
return z==null?$.vB.prototype.bu.call(this,a):z}},G7:{"":"qE;oc:name="},ax:{"":"qE;P:value="},wL:{"":"qE;oc:name=,P:value="},HD:{"":"qE;oc:name=,P:value="},nC:{"":"uH;N:target="},KR:{"":"qE;P:value="},lp:{"":"qE;B:length=,oc:name=,tL:size=,P:value="},AE:{"":"qE;oc:name=,P:value="},K5:{"":"D0;",
...
$asXj:null,
$isList:true,
$isXj:true}}],["dart.dom.svg","dart:svg",,{Y0:{"":"tp;N:target="},tp:{"":"nj;"},nj:{"":"d5;"},d5:{"":"cv;"}}],["dart.isolate","dart:isolate",,{WP:function(){if($.Dz==null)$.Dz=$.K4()
...
$asXj:null,
$isList:true,
$isXj:true}}],["slicing.dart","file:///Users/shailentuli/workspace/dart-samples/web/html5/file/dndfiles/slicing.dart",,{E2:function(){$.SD()},XK:{"":"a;hJ,P5<,Vy<",
Nd:function(a){var z,y,x,w
z=$.l2(a)
if(typeof z==="object"&&z!==null&&!!$.x(z).$isIF){y=new $.i7(z).bB.getAttribute("data-startbyte")
x=new $.i7(z).bB.getAttribute("data-endbyte")
w=y!=null?$.Hp(y,null,null):null
this.VY(w,x!=null?$.Hp(x,null,null):null)}},
gqJ:function(){return new $.FB(this,"Nd",null)},
VY:function(a,b){var z,y,x,w,v,u
z=$.co(this.hJ)
y=$.U6(z)
if($.de(y.gB(z),0)){window.alert("Please select a file!")
return}x=y.t(z,0)
w=a!=null?a:0
v=b!=null?b:$.nu(x)
u=new FileReader()
C.fK.zc
y=new $.RO(u,C.fK.fV,!1)
new $.xC(0,y.hA,y.fV,new $.Ee(this,x,w,v,u),y.dW).wv()
u.readAsBinaryString($.mZ(x,w,v))},
A3:function(){var z,y
this.P5=document.querySelector("#byte-content")
this.Vy=document.querySelector("#byte-range")
this.hJ=document.querySelector("#files")
z=this.hJ
z.gi9
C.mt.Qm
z=new $.Cq(z,C.mt.fV,!1)
new $.xC(0,z.hA,z.fV,new $.iD(this),z.dW).wv()
y=document.querySelector("#read-bytes-buttons")
y.gVl
C.T1.Qm
z=new $.Cq(y,C.T1.fV,!1)
new $.xC(0,z.hA,z.fV,this.gqJ(),z.dW).wv()},
static:{SD:function(){var z=new $.XK(null,null,null)
z.A3()
return z}}},iD:{"":"Tp;a",
call$1:function(a){var z=this.a
z.gP5().textContent=""
z.gVy().textContent=""}},Ee:{"":"Tp;a,b,c,d,e",
call$1:function(a){var z=this.a
z.gP5().textContent=this.e.result
z.gVy().textContent="Read bytes "+$.d($.WB(this.c,1))+" - "+$.d($.WB(this.d,1))+" of "+$.d($.nu(this.b))+"."}}},1],])
...
$.mZ=function(a,b,c){return $.RE(a).yh(a,b,c)}
...
$.VQ("ArrayBuffer|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedString",$.vB)
