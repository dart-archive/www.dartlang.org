...
return}throw "Unable to print message: " + String(a)}}],["","file:///Users/shailentuli/workspace/dart-samples/html5/web/file/dndfiles/slicing.dart",,D,{
"^":"",
Iq:[function(){D.SD()},"call$0","eE",0,0,1],
XK:{
"^":"a;E6,MK,Qj",
hg:[function(a){var z,y,x,w
z=J.l2(a)
if(!!J.x(z).$isIF){y=z.getAttribute("data-startbyte")
x=z.getAttribute("data-endbyte")
w=y!=null?H.Hp(y,null,null):null
this.ao(w,x!=null?H.Hp(x,null,null):null)}},"call$1","gbK",2,0,17],
ao:function(a,b){var z,y,x,w,v,u
z=J.co(this.E6)
y=z.length
if(y===0){window.alert("Please select a file!")
return}if(0>=y)return H.e(z,0)
x=z[0]
w=a!=null?a:0
v=b!=null?b:x.size
u=new FileReader()
y=H.VM(new W.RO(u,C.fK.Ph,!1),[null])
H.VM(new W.xC(0,y.uv,y.Ph,W.VF(new D.Ee(this,x,w,v,u)),y.Sg),[H.Kp(y,0)]).Zz()
u.readAsDataURL(x.slice(w,v))},
A3:function(){this.MK=document.querySelector("#byte-content")
this.Qj=document.querySelector("#byte-range")
var z=document.querySelector("#files")
this.E6=z
z=J.uX(z)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new D.iD(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#read-bytes-buttons"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(this.gbK()),z.Sg),[H.Kp(z,0)]).Zz()},
static:{SD:function(){var z=new D.XK(null,null,null)
z.A3()
return z}}},
iD:{
"^":"Tp:8;a",
...
"^":"Tp:8;a,b,c,d,e",
call$1:function(a){var z=this.a
z.MK.textContent=C.Uy.gyG(this.e)
z.Qj.textContent="Read bytes "+H.d(J.WB(this.c,1))+" - "+H.d(J.WB(this.d,1))+" of "+H.d(this.b.size)+"."}}},1],])
...
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"bB",void:true,args:[W.Aj]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
KX.prototype=$desc
function uZ(UI,wX,Gq,Rm){this.UI=UI
this.wX=wX
this.Gq=Gq
...
if($desc instanceof Array)$desc=$desc[1]
rq.prototype=$desc
function RW(c,b,UI,wX){this.c=c
this.b=b
this.UI=UI
this.wX=wX}RW.builtin$cls="RW"
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
function XK(E6,MK,Qj){this.E6=E6
this.MK=MK
this.Qj=Qj}XK.builtin$cls="XK"
if(!"name" in XK)XK.name="XK"
$desc=$collectedClasses.XK
if($desc instanceof Array)$desc=$desc[1]
XK.prototype=$desc
function iD(a){this.a=a}iD.builtin$cls="iD"
if(!"name" in iD)iD.name="iD"
$desc=$collectedClasses.iD
if($desc instanceof Array)$desc=$desc[1]
iD.prototype=$desc
function Ee(a,b,c,d,e){this.a=a
this.b=b
this.c=c
this.d=d
this.e=e}Ee.builtin$cls="Ee"
if(!"name" in Ee)Ee.name="Ee"
$desc=$collectedClasses.Ee
if($desc instanceof Array)$desc=$desc[1]
Ee.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,dU,Aa,XV,H0,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,GS,Qb,PG,F3,xI,Aj,Q0,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,Zc,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,o4,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,D8,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,vs,da,pV,U7,rq,RW,RT,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,FN,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,aE,kM,An,c8,a,mE,Rn,wv,zL,ec,dx,x5,Fk,RO,eu,xC,Pb,W9,dW,IU,b0,Pg,Ob,GV,XK,iD,Ee]}