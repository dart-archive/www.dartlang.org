...
GE:{
"^":"Tp:7;a",
call$1:function(a){return a.h(0,this.a)}}}],["","file:///Users/shailentuli/workspace/dart-samples/html5/web/file/dndfiles/monitoring.dart",,E,{
"^":"",
Iq:[function(){E.Xb()},"call$0","eE",0,0,0],
hZ:{
"^":"a;lZ,aC,j9",
VQ:function(a){a=P.J(100,P.y(0,a))
J.vP(this.aC.style,""+a+"%")
this.aC.textContent=""+a+"%"
if(a===0||a===100)P.rT(C.nn,new E.p5(this))},
To:function(){var z,y
this.VQ(0)
J.pP(this.aC).Rz(0,"loading")
z=J.co(this.lZ)
if(0>=z.length)return H.e(z,0)
y=z[0]
z=new FileReader()
...
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.PM(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=this.j9
z.toString
z=H.VM(new W.RO(z,C.lU.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(this.gXo()),z.Sg),[H.Kp(z,0)]).Zz()
z=this.j9
z.toString
z=H.VM(new W.RO(z,C.zU.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.Cf()),z.Sg),[H.Kp(z,0)]).Zz()
z=this.j9
z.toString
z=H.VM(new W.RO(z,C.Ac.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.Hj(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=this.j9
z.toString
z=H.VM(new W.RO(z,C.fK.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.et(this)),z.Sg),[H.Kp(z,0)]).Zz()
this.j9.readAsText(y)},
mj:[function(a){var z,y
if(J.cc(a)===!0){z=a.loaded
if(typeof z!=="number")return H.s(z)
y=a.total
if(typeof y!=="number")return H.s(y)
this.VQ(C.jn.yu(C.CD.yu(C.jn.UD(100*z/y))))}},"call$1","gXo",2,0,17],
WW:function(){this.aC=document.querySelector("#progress-bar")
var z=document.querySelector("#files")
this.lZ=z
z=J.uX(z)
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.Ma(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=J.Vg(document.querySelector("#cancel-read"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new E.Qr(this)),z.Sg),[H.Kp(z,0)]).Zz()},
static:{Xb:function(){var z=new E.hZ(null,null,null)
z.WW()
return z}}},
Ma:{
"^":"Tp:7;a",
call$1:function(a){return this.a.To()}},
Qr:{
"^":"Tp:7;b",
call$1:function(a){var z=this.b.j9
if(z!=null)z.abort()
return}},
p5:{
"^":"Tp:5;a",
call$0:function(){return J.pP(this.a.aC).Rz(0,"loading")}},
PM:{
"^":"Tp:7;a",
call$1:function(a){switch(this.a.j9.error.code){case 1:window.alert("File not found!")
break
...
Cf:{
"^":"Tp:7;",
call$1:function(a){return window.alert("File read cancelled.")}},
Hj:{
"^":"Tp:7;b",
call$1:function(a){return J.pP(this.b.aC).h(0,"loading")}},
et:{
"^":"Tp:7;c",
call$1:function(a){return this.c.VQ(100)}}},1],])
...
return J.Qc(a).g(a,b)}
J.cc=function(a){return J.RE(a).gZn(a)}
...
init.metadata=[{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"uO",args:[J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:J.O,args:[J.im]},{func:"Qh",void:true,args:[W.ew]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
ew.prototype=$desc
ew.prototype.gZn=function(receiver){return receiver.lengthComputable}
function fs(){}fs.builtin$cls="fs"
if(!"name" in fs)fs.name="fs"
$desc=$collectedClasses.fs
if($desc instanceof Array)$desc=$desc[1]
...
if($desc instanceof Array)$desc=$desc[1]
GE.prototype=$desc
function hZ(lZ,aC,j9){this.lZ=lZ
this.aC=aC
this.j9=j9}hZ.builtin$cls="hZ"
...
if($desc instanceof Array)$desc=$desc[1]
Ma.prototype=$desc
function Qr(b){this.b=b}Qr.builtin$cls="Qr"
...
if($desc instanceof Array)$desc=$desc[1]
Cf.prototype=$desc
function Hj(b){this.b=b}Hj.builtin$cls="Hj"
if(!"name" in Hj)Hj.name="Hj"
$desc=$collectedClasses.Hj
if($desc instanceof Array)$desc=$desc[1]
Hj.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
et.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,Az,QP,IF,n6,Ny,nx,QQ,fW,y4,d7,Um,oJ,He,HA,vH,xO,Em,NW,rV,Wy,QF,hs,cm,Nh,cv,Fs,hY,ea,D0,as,dU,Aa,XV,H0,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,Q0,eY,KV,KY,G7,l9,Ql,wL,bP,mX,SN,HD,ni,rR,qj,nC,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,I0,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,kJ,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,UM,hq,WS,r0,yp,c1,Mq,Nf,Nc,Mx,rh,Zv,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,Pe,UD,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Qm,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,vK,Iy,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,vs,da,pV,U7,rq,RW,RT,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,EH,An,c8,a,mE,Rn,wv,BV,id,zL,ec,dx,x5,I4,Fk,RO,eu,xC,Pb,W9,O7,IU,b0,Pg,Ob,GV,As,GE,hZ,Ma,Qr,p5,PM,Cf,Hj,et]}