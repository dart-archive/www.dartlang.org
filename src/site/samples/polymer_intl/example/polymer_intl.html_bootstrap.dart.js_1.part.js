...
var i=[]
processStatics(m)
x.push([q,p,j,i,o,k,l,n])}})([["","",,M,{
"^":"",
pw:{
"^":"Pg;jH<,ng",
gut:function(){return"fr"},
static:{VD:[function(){return"Bonjour tout le monde de Dart!"},"$0","bq",0,0,62]}}}],])
I.$finishClasses($$,$,I.p)
$=arguments[1]
C.Lv=new H.RM(1,{helloFromDart:M.bq()},C.vi)
}
$dart_deferred_initializers["iZDlVlBI5govsdIEX1opAVxJ3OQ="]=$dart_deferred_initializers.current
