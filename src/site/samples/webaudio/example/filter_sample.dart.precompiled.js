...
"%":"ArrayBuffer|AudioParam|Blob|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList"},
kn:{
"^":"bool/Gv;",
...
lz:{
"^":"Tp;a,b,c,d",
call$1:function(a){P.PN(new P.Rl(this.c,a),new P.Jb(),P.TB(this.a.a,this.d))},
...
Sw:{
"^":"mW;v5,av,eZ,qT",
gA:function(a){return new P.UQ(this,this.eZ,this.qT,this.av,null)},
aN:function(a,b){var z,y,x
z=this.qT
...
$isiP:true,
static:{"^":"Oj,Vp,df,yz,ch,QC,Px,Yp,kc,Gi,Fz,cR,E0,Ke,lT,Nr,bm,o4,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
$isD0:true,
"%":"AudioBufferSourceNode|AudioDestinationNode|AudioNode|AudioSourceNode|BiquadFilterNode;EventTarget"},
Yu:{
"^":"qE;B:length=",
"%":"HTMLFormElement"},
zU:{
...
z=this.b.MM
if(z.Gv!==0)H.vh(P.w("Future already completed"))
z.CG(a,null)}}}],["dart.isolate","dart:isolate",,P,{
"^":"",
IU:{
"^":"a;",
$isIU:true,
...
return}throw "Unable to print message: " + String(a)}}],["","file:///Users/shailentuli/workspace/dart-samples/html5/web/webaudio/intro/filter_sample.dart",,O,{
"^":"",
Iq:[function(){var z=new O.w1(null,null)
z.IV()
O.fY(z)},"call$0","eE",0,0,1],
wT:{
"^":"a;GS,WG,FR,ur,mJ",
LY:function(a){return this.FR.call$1(a)},
xW:function(a){var z,y
for(z=this.WG,y=0;y<z.length;++y)this.oz(z[y],y)},
...
w=new W.xC(0,z,y,W.VF(new O.Ux(this,a,b,z)),!1)
...
x=new W.RO(z,y,!1)
x.$builtinTypeInfo=[null]
w=new W.xC(0,z,y,W.VF(new O.KV()),!1)
w.$builtinTypeInfo=[H.Kp(x,0)]
x=w.u7
if(x!=null&&w.VP<=0)J.qV(w.uv,y,x,!1)
z.send()},
lR:function(a,b,c){J.Pc(this.GS,W.DA(a.response)).ml(new O.AJ(this,b,c))}},
Ux:{
"^":"Tp:8;a,b,c,d",
call$1:function(a){return this.a.lR(this.d,this.b,this.c)}},
KV:{
"^":"Tp:8;",
call$1:function(a){return window.alert("BufferLoader: XHR error")}},
AJ:{
"^":"Tp:17;a,b,c",
...
z=C.Xz.gUQ(C.Xz)
x=P.F(z,!0,H.ip(z,"mW",0))
w=new O.wT(this.GS,x,new O.ut(this,y),0,null)
z=Array(x.length)
z.fixed$length=init
w.mJ=H.VM(z,[P.r2])
w.xW(0)},
IV:function(){this.G1=P.L5(null,null,null,J.O,P.r2)
...
x.G1.u(0,u,v)}}},
l9:{
"^":"a;Fo,Jx,mj,r7,QI,EQ,zO",
vy:function(a){var z=J.Vg(document.querySelector("#play-pause-button"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new O.oC(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=J.uX(document.querySelector("#enable-filter-checkbox"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new O.FE(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=J.uX(document.querySelector("#frequency-range"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new O.IW(this)),z.Sg),[H.Kp(z,0)]).Zz()
z=J.uX(document.querySelector("#quality-range"))
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new O.Iy(this)),z.Sg),[H.Kp(z,0)]).Zz()},
static:{fY:function(a){var z=new O.l9(5000,7000,30,!1,a,null,null)
z.vy(a)
return z}}},
oC:{
"^":"Tp:19;a",
...
y.toString
if(!!y.stop)y.stop(0)
else y.noteOff(0)}else{y=z.QI
x=y.GS.createBufferSource()
z.EQ=x
x.buffer=y.G1.t(0,"example")
x=y.GS.createBiquadFilter()
z.zO=x
x.type="lowpass"
x.frequency.value=z.Fo
z.EQ.connect(x,0,0)
z.zO.connect(y.GS.destination,0,0)
y=z.EQ
y.toString
if(!!y.start)y.start(0)
else y.noteOn(0)
z.EQ.loop=!0}z.r7=!z.r7}},
FE:{
"^":"Tp:19;b",
call$1:function(a){var z,y,x,w
z=H.Go(J.BC(a),"$isMi").checked
y=this.b
y.EQ.disconnect(0)
y.zO.disconnect(0)
x=y.EQ
w=y.QI
if(z===!0){x.connect(y.zO,0,0)
y.zO.connect(w.GS.destination,0,0)}else x.connect(w.GS.destination,0,0)}},
IW:{
"^":"Tp:19;c",
call$1:function(a){var z,y,x,w,v,u
z=H.IH(H.Go(J.BC(a),"$isMi").value,null)
y=this.c
x=y.QI.GS.sampleRate
if(typeof x!=="number")return x.V()
w=x/2
x=Math.log(w/40)
v=J.xH(z,1)
if(typeof v!=="number")return H.s(v)
u=Math.pow(2,x/0.6931471805599453*v)
y.zO.frequency.value=w*u}},
Iy:{
"^":"Tp:19;d",
call$1:function(a){var z,y
z=H.IH(H.Go(J.BC(a),"$isMi").value,null)
y=this.d
y.zO.Q.value=J.vX(z,y.mj)}}},1],["html_common","dart:html_common",,P,{
"^":"",
...
C.Xz=new H.LP(1,{example:"sounds/example.ogg"},C.au)
C.vB=J.is.prototype
$.libraries_to_load = {}
$.te="$cachedFunction"
$.eb="$cachedInvocation"
...
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},{func:"K0",args:[P.r2]},{func:"mR",args:[[J.Q,P.r2]]},{func:"dG",args:[W.ea]},{func:"ZH",args:[J.im]},{func:"iR",args:[J.im,null]},];$=null
...
if($desc instanceof Array)$desc=$desc[1]
RA.prototype=$desc
function IY(od,i3,P8){this.od=od
this.i3=i3
...
if($desc instanceof Array)$desc=$desc[1]
LK.prototype=$desc
function AT(P8){this.P8=P8}AT.builtin$cls="AT"
...
if($desc instanceof Array)$desc=$desc[1]
GV.prototype=$desc
function wT(GS,WG,FR,ur,mJ){this.GS=GS
this.WG=WG
this.FR=FR
this.ur=ur
this.mJ=mJ}wT.builtin$cls="wT"
if(!"name" in wT)wT.name="wT"
$desc=$collectedClasses.wT
if($desc instanceof Array)$desc=$desc[1]
wT.prototype=$desc
function Ux(a,b,c,d){this.a=a
this.b=b
this.c=c
...
if($desc instanceof Array)$desc=$desc[1]
AJ.prototype=$desc
function w1(G1,GS){this.G1=G1
this.GS=GS}w1.builtin$cls="w1"
if(!"name" in w1)w1.name="w1"
$desc=$collectedClasses.w1
if($desc instanceof Array)$desc=$desc[1]
w1.prototype=$desc
function ut(a,b){this.a=a
this.b=b}ut.builtin$cls="ut"
if(!"name" in ut)ut.name="ut"
$desc=$collectedClasses.ut
if($desc instanceof Array)$desc=$desc[1]
ut.prototype=$desc
function l9(Fo,Jx,mj,r7,QI,EQ,zO){this.Fo=Fo
this.Jx=Jx
this.mj=mj
this.r7=r7
this.QI=QI
this.EQ=EQ
this.zO=zO}l9.builtin$cls="l9"
...
if($desc instanceof Array)$desc=$desc[1]
oC.prototype=$desc
function FE(b){this.b=b}FE.builtin$cls="FE"
if(!"name" in FE)FE.name="FE"
$desc=$collectedClasses.FE
if($desc instanceof Array)$desc=$desc[1]
FE.prototype=$desc
function IW(c){this.c=c}IW.builtin$cls="IW"
if(!"name" in IW)IW.name="IW"
$desc=$collectedClasses.IW
if($desc instanceof Array)$desc=$desc[1]
IW.prototype=$desc
function Iy(d){this.d=d}Iy.builtin$cls="Iy"
if(!"name" in Iy)Iy.name="Iy"
$desc=$collectedClasses.Iy
if($desc instanceof Array)$desc=$desc[1]
Iy.prototype=$desc
...
if($desc instanceof Array)$desc=$desc[1]
xL.prototype=$desc
return[qE,Gh,rK,xZ,Mr,lJ,ct,nB,i3,it,Az,QP,IF,Ny,QQ,y4,d7,Um,He,HA,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,Ty,ea,D0,as,dU,Aa,u5,Yu,iG,jP,mK,xf,Vb,ST,zU,wa,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,Vh,rC,ZY,cx,Ee,Qb,PG,F3,xI,Aj,Q0,eY,uH,KY,G7,b1,Ql,wL,bP,mX,SN,HD,ni,rR,qj,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,FH,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,r0,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Dh,ZJ,mU,eZ,IT,nV,ui,D6,DQ,Sm,dx,es,jw,lv,pf,NV,W1,zo,wf,hq,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,d0,tp,rE,CC,PQ,uz,Yd,p8,AD,Gr,cs,GH,To,NJ,qI,jf,rQ,Lx,f6,d5,hy,r8,aS,CG,UN,MT,Rk,Eo,YS,UM,ZD,vt,cu,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,r2,j4,WK,p2,vN,rO,xl,XN,VN,Xr,Gn,Sl,Qm,D8,ET,V6,FK,Gv,kn,YE,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,oU,cC,RA,IY,JH,jl,vK,I4,JM,Ua,ns,yo,Bj,NO,II,fP,X1,HU,oo,OW,Tf,iY,yH,FA,Av,ku,ys,LP,hY,XR,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Pe,tc,lb,tD,hJ,dC,wN,VX,a7,i1,xy,MH,SU,Ca,Pf,Zf,vs,da,pV,U7,rH,cX,ZL,rq,RW,YP,jZ,FZ,OM,qh,lz,Rl,Jb,M4,B5,PI,MO,nP,dR,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,FN,ZQ,Sw,UQ,CL,iP,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,Ts,VS,t7,HG,oe,kM,EH,An,c8,a,mE,Rn,wv,I2,RO,eu,xC,dW,Sq,C3,IU,b0,Pg,Ob,GV,wT,Ux,KV,AJ,w1,ut,l9,oC,FE,IW,Iy,a9,YL,KC,xL]}