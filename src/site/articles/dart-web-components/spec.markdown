...
encapsulation to help you write web applications at scale.
...
Just like [MDV][mdv] templates, the DWC template syntax is valid HTML.
Hence, it
...
If a change made in your data doesn't automatically appear in the UI,
it is very
...
<div class="alert alert-info">
<strong>Status:</strong>
Autogenerating a script tag is not yet implemented.
in the DWC compiler.
</div>
</aside>
