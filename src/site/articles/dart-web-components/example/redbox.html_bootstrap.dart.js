...
$$.RedBox = {"":
 ...
 created_autogenerated$0: function() {
  this._root.set$innerHTML('    <div style="border-color: red; border: 1px">\n    <content></content>\n    </div>\n    ');
  this.created$0();
},
 inserted_autogenerated$0: function() {
  this.inserted$0();
},
 RedBox$forElement$1: function(e) {
...
$.init_autogenerated = function() {
  var _root = $.DocumentFragment_DocumentFragment$html('<!-- TODO(sigmund): add this example to explainer document once we have this\nfeature working (issue #62). -->\n\n<div class="well">\n<x-redbox id="__e-0">\n<span>hi</span>\n</x-redbox>\n</div>\n');
  $.___e0 = _root.query$1('#__e-0');
  $.RedBox$forElement($.___e0).created_autogenerated$0();
...
$.RedBox$forElement = function(e) {
  var t1 = new $.RedBox(null, e);
  t1.WebComponent$forElement$1(e);
  t1.RedBox$forElement$1(e);
  return t1;
};
...
$.CTC44 = 'table';
$.CTC45 = 'audio';
$.CTC16 = new Isolate.$isolateProperties.ConstantMap(11, {'body': 'html', 'head': 'html', 'caption': 'table', 'td': 'tr', 'colgroup': 'table', 'col': 'colgroup', 'tr': 'tbody', 'tbody': 'table', 'tfoot': 'table', 'thead': 'table', 'track': 'audio'}, Isolate.$isolateProperties.CTC37);
...
//@ sourceMappingURL=_redbox.html_bootstrap.dart.js.map