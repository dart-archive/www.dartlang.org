...
app, use `pub
      build` to generate the final files.
...
5.  Click **Finish** to create a directory with initial files for the
    ...
    ![A new app, pre-filled with basic, runnable
    code](figs/web/daur_0401.png)
...
![Using Dart Editor to debug the Sunflower sample
app](figs/web/daur_0406.png)
