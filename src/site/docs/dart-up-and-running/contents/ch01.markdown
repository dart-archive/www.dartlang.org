...
web platform seemed to be stagnating. It worked. As ? shows, browser
...
You’ll learn about the Dart language and libraries in Chapters ? and ?
respectively.
...
4.  Move the slider to change the sunflower's display, as shown in ?.
    ...
    ![The Sunflower sample running in Dartium](figs/web/daur_0105.png)
...
3.  Make sure **Generate sample content** and **Command-line
    ...
    ![Create command-line or web apps with Dart
    Editor](figs/web/daur_0103.png)
