...
{% assign bii = '&nbsp;<sup title="built-in-identifier" alt="built-in-identifier"><span class="glyphicon glyphicon-star"></span></sup>' %}
{% assign lrw = '&nbsp;<sup title="limited reserved word" alt="limited reserved word"><span class="glyphicon glyphicon-asterisk"></span></sup>' %}
...
In the keyword table, words with a star
(<span title="built-in-identifier" alt="built-in-identifier" style="font-size:smaller"><span
...
{% comment %}
TODO: DELETE THIS ONCE TABLE WORK IS DONE.
| abstract{{bii}}   |
| as{{bii}}         |
| assert            |
| async{{lrw}}      |
