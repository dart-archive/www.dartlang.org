...
["", "download_archive.dart", , E, {
  ...
  addStableVersion__closure: {
    ...
    call$2: [function(width, archives) {
      ...
      t6 = t5.addCell$0(row);
      t6.toString;
      new W._ElementCssClassSet(t6).add$1(0, "nowrap");
      t6.textContent = width;
      c = t5.addCell$0(row);
      c.toString;
...
function dart_precompiled($collectedClasses) {
  ...
  function getStableListing_closure() {
  }
  getStableListing_closure.builtin$cls = "getStableListing_closure";
  if (!"name" in getStableListing_closure)
    getStableListing_closure.name = "getStableListing_closure";
  $desc = $collectedClasses.getStableListing_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStableListing_closure.prototype = $desc;
  function getStableListing_closure0() {
  }
  getStableListing_closure0.builtin$cls = "getStableListing_closure0";
  if (!"name" in getStableListing_closure0)
    getStableListing_closure0.name = "getStableListing_closure0";
  $desc = $collectedClasses.getStableListing_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStableListing_closure0.prototype = $desc;
  function getStableListing_closure1(channel_0) {
    this.channel_0 = channel_0;
  }
  getStableListing_closure1.builtin$cls = "getStableListing_closure1";
  if (!"name" in getStableListing_closure1)
    getStableListing_closure1.name = "getStableListing_closure1";
  $desc = $collectedClasses.getStableListing_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStableListing_closure1.prototype = $desc;
  function getStableListing__closure() {
  }
  getStableListing__closure.builtin$cls = "getStableListing__closure";
  if (!"name" in getStableListing__closure)
    getStableListing__closure.name = "getStableListing__closure";
  $desc = $collectedClasses.getStableListing__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStableListing__closure.prototype = $desc;
  function getStableListing__closure0() {
  }
  getStableListing__closure0.builtin$cls = "getStableListing__closure0";
  if (!"name" in getStableListing__closure0)
    getStableListing__closure0.name = "getStableListing__closure0";
  $desc = $collectedClasses.getStableListing__closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStableListing__closure0.prototype = $desc;
  function getStableListing__closure1(channel_1) {
    this.channel_1 = channel_1;
  }
  getStableListing__closure1.builtin$cls = "getStableListing__closure1";
  if (!"name" in getStableListing__closure1)
    getStableListing__closure1.name = "getStableListing__closure1";
  $desc = $collectedClasses.getStableListing__closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  getStableListing__closure1.prototype = $desc;
  function addStableVersion_closure(channel_0, version_1) {
    this.channel_0 = channel_0;
    this.version_1 = version_1;
  }
  addStableVersion_closure.builtin$cls = "addStableVersion_closure";
  if (!"name" in addStableVersion_closure)
    addStableVersion_closure.name = "addStableVersion_closure";
  $desc = $collectedClasses.addStableVersion_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  addStableVersion_closure.prototype = $desc;
  function addStableVersion__closure(channel_2, version_3, name_4) {
    this.channel_2 = channel_2;
    this.version_3 = version_3;
    this.name_4 = name_4;
  }
  addStableVersion__closure.builtin$cls = "addStableVersion__closure";
  if (!"name" in addStableVersion__closure)
    addStableVersion__closure.name = "addStableVersion__closure";
  $desc = $collectedClasses.addStableVersion__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  addStableVersion__closure.prototype = $desc;
  function addStableVersion___closure(channel_5, version_6, name_7, width_8, archives_9, c_10) {
    this.channel_5 = channel_5;
    this.version_6 = version_6;
    this.name_7 = name_7;
    this.width_8 = width_8;
    this.archives_9 = archives_9;
    this.c_10 = c_10;
  }
  addStableVersion___closure.builtin$cls = "addStableVersion___closure";
  if (!"name" in addStableVersion___closure)
    addStableVersion___closure.name = "addStableVersion___closure";
  $desc = $collectedClasses.addStableVersion___closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  addStableVersion___closure.prototype = $desc;
  function addStableVersion_closure0() {
  }
  addStableVersion_closure0.builtin$cls = "addStableVersion_closure0";
  if (!"name" in addStableVersion_closure0)
    addStableVersion_closure0.name = "addStableVersion_closure0";
  $desc = $collectedClasses.addStableVersion_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  addStableVersion_closure0.prototype = $desc;
